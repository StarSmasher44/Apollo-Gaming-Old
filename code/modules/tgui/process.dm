 ...
 **/
/datum/subsystem/html_ui/proc/try_update_ui(mob/user, datum/src_object, ui_key, datum/tgui/ui, force_open = 0)
  ...
  * return datum/tgui The found UI.
 **/
/datum/subsystem/html_ui/proc/get_open_ui(mob/user, datum/src_object, ui_key)
 ...
 **/
/datum/subsystem/html_ui/proc/update_uis(datum/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(tg_open_uis[src_object_key]) || !istype(tg_open_uis[src_object_key], /list))
 ...
 **/
/datum/subsystem/html_ui/proc/close_uis(datum/src_object)
	var/src_object_key = "\ref[src_object]"
	if(isnull(tg_open_uis[src_object_key]) || !istype(tg_open_uis[src_object_key], /list))
		return 0 // Couldn't find any UIs for this object.
  ...
  * return int The number of UIs updated.
 **/
/datum/subsystem/html_ui/proc/update_user_uis(mob/user, datum/src_object = null, ui_key = null)
  ...
  * return int The number of UIs closed.
 **/
/datum/subsystem/html_ui/proc/close_user_uis(mob/user, datum/src_object = null, ui_key = null)
	if(isnull(user.tg_open_uis) || !istype(user.tg_open_uis, /list) || tg_open_uis.len == 0)
		return 0 // Couldn't find any UIs for this user.
 ...
 **/
/datum/subsystem/html_ui/proc/on_open(datum/tgui/ui)
 ...
 **/
/datum/subsystem/html_ui/proc/on_close(datum/tgui/ui)
	var/src_object_key = "\ref[ui.src_object]"
	if(isnull(tg_open_uis[src_object_key]) || !istype(tg_open_uis[src_object_key], /list))
  ...
  * return int The number of UIs closed.
 **/
/datum/subsystem/html_ui/proc/on_logout(mob/user)
 ...
 **/
/datum/subsystem/html_ui/proc/on_transfer(mob/source, mob/target)
